...
var _user$project$ChatInput$message = _elm_lang$core$Native_Platform.outgoingPort(
	'message',
	function (v) {
		return v;
	});
var _user$project$ChatInput$Model = function (a) {
	return {input: a};
};
var _user$project$ChatInput$init = {
	ctor: '_Tuple2',
	_0: _user$project$ChatInput$Model(''),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$ChatInput$update = F2(
	function (msg, _p0) {
		var _p1 = _p0;
		var _p2 = msg;
		if (_p2.ctor === 'Input') {
			return {
				ctor: '_Tuple2',
				_0: _user$project$ChatInput$Model(_p2._0),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
			return {
				ctor: '_Tuple2',
				_0: _user$project$ChatInput$Model(''),
				_1: _user$project$ChatInput$message(_p1.input)
			};
		}
	});
var _user$project$ChatInput$Send = {ctor: 'Send'};
var _user$project$ChatInput$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _user$project$ChatInput$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_user$project$ChatInput$Input),
					_1: {
						ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$ChatInput$Send),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$ChatInput$main = _elm_lang$html$Html$program(
	{
		init: _user$project$ChatInput$init,
		view: _user$project$ChatInput$view,
		update: _user$project$ChatInput$update,
		subscriptions: function (_p3) {
			return _elm_lang$core$Platform_Sub$none;
		}
	})();

var _user$project$ChatUsers$repl = A3(
	_elm_lang$core$Regex$replace,
	_elm_lang$core$Regex$All,
	_elm_lang$core$Regex$regex('[123456789\\[\\]]'),
	function (_p0) {
		return '';
	});
var _user$project$ChatUsers$parseSocketIOMessage = function (str) {
	var raw = _user$project$ChatUsers$repl(str);
	var spl = _elm_lang$core$Array$fromList(
		A2(_elm_lang$core$String$split, ',', raw));
	var _p1 = A2(_elm_lang$core$Array$get, 1, spl);
	if (_p1.ctor === 'Nothing') {
		return '';
	} else {
		return _p1._0;
...
var _user$project$ChatUsers$usersStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$ChatUsers$viewUser = function (usr) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(usr),
			_1: {ctor: '[]'}
		});
};
var _user$project$ChatUsers$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('chat-container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$ChatUsers$usersStyle,
						_1: {ctor: '[]'}
					}
				},
				A2(
					_elm_lang$core$List$map,
					_user$project$ChatUsers$viewUser,
					_elm_lang$core$List$reverse(model.users))),
			_1: {ctor: '[]'}
		});
};
var _user$project$ChatUsers$Model = F2(
	function (a, b) {
		return {server: a, users: b};
	});
var _user$project$ChatUsers$init = {
	ctor: '_Tuple2',
	_0: A2(
		_user$project$ChatUsers$Model,
		'ws://localhost:3000/socket.io/?EIO=3&transport=websocket',
		{ctor: '[]'}),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$ChatUsers$Login = function (a) {
	return {username: a};
};
var _user$project$ChatUsers$loginDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'username',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$ChatUsers$Login));
var _user$project$ChatUsers$decodeLogin = function (raw) {
	var x = _user$project$ChatUsers$parseSocketIOMessage(raw);
	var res = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$ChatUsers$loginDecoder, x);
	var _p2 = res;
	if (_p2.ctor === 'Err') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
...
var _user$project$ChatUsers$update = F2(
	function (msg, _p3) {
		var _p4 = _p3;
		var _p7 = _p4;
		var _p5 = msg;
		var _p6 = _user$project$ChatUsers$decodeLogin(_p5._0);
		if (_p6.ctor === 'Nothing') {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					_p7,
					{
						users: {ctor: '::', _0: _p6._0.username, _1: _p4.users}
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$ChatUsers$NewLogin = function (a) {
	return {ctor: 'NewLogin', _0: a};
};
var _user$project$ChatUsers$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, model.server, _user$project$ChatUsers$NewLogin);
};
var _user$project$ChatUsers$main = _elm_lang$html$Html$program(
	{init: _user$project$ChatUsers$init, view: _user$project$ChatUsers$view, update: _user$project$ChatUsers$update, subscriptions: _user$project$ChatUsers$subscriptions})();

var Elm = {};
Elm['ChatInput'] = Elm['ChatInput'] || {};
if (typeof _user$project$ChatInput$main !== 'undefined') {
    _user$project$ChatInput$main(Elm['ChatInput'], 'ChatInput', undefined);
}
Elm['ChatUsers'] = Elm['ChatUsers'] || {};
if (typeof _user$project$ChatUsers$main !== 'undefined') {
    _user$project$ChatUsers$main(Elm['ChatUsers'], 'ChatUsers', undefined);
}
